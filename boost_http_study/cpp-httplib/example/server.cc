...
int main(void) {
    ...
    svr.Get("/favicon.ico", [](const Request & /*req*/, Response &res) { res.set_content("favicon\n", "text/plain"); });
    ...
    svr.Get("/dump",
            [](const Request &req, Response &res) { res.set_content(dump_headers(req.headers), "text/plain"); });

    svr.Get("/stop", [&](const Request & /*req*/, Response & /*res*/) { svr.stop(); });

    svr.Post("/post", [&](const Request & /*req*/, Response &res) { res.set_content("Hello World!\n", "text/plain"); });
