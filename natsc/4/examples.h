...
static natsStatus parseUrls(const std::vector<std::string> &urls, natsOptions *gopts) {
    ...
    natsStatus s = NATS_OK;
    s = natsOptions_SetServers(gopts, (const char **)serverUrls, urls.size());
